...
open class SimpleRecyclerView
	...
	init {
		itemAnimator = ChangeAnimationDelegator(DefaultItemAnimator())
	}

	override fun setItemAnimator(animator: ItemAnimator?) {
		if (animator != null)
			super.setItemAnimator(ChangeAnimationDelegator(animator))
		else
			super.setItemAnimator(animator)
	}

	override fun getItemAnimator(): ItemAnimator?
			= (super.getItemAnimator() as? ItemAnimatorDecorator)?.decorated


	private inner class ChangeAnimationDelegator(animator: ItemAnimator) : ItemAnimatorDecorator(animator) {
